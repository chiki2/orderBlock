...
input double               ADX_Max                 = 60.0; // ADX Max
int                  Fast_MA_Period          = 15;   // Fast MA Period
int                  Slow_MA_Period          = 45;   // Slow MA Period
input int                  ATR_Period              = 20; // ATR period
input double               ATR_multiplier          = 3.5; // ATR multiplier (for trailing stop)
input double               ATR_max                 = 6; // ATR Max (no trade above)
...
input double               fiboStopLoss            = -0.25; // Set Starting SL based on fibonacci
